<template>
  <view class="base-info-wrapper">
    ...
    <view class="land-title"> 小型专项及农副业设施评估报告 </view>

    <view class="land-txt"> {{ baseInfo.name }}设施设备出具评估报告结果如下： </view>
    <view class="land-txt">一、小型专项及农副业设施评估情况</view>
    <view class="table-wrap">
      <uni-table class="table" ref="table" border stripe emptyText="暂无更多数据">
        ...
        <uni-tr
          v-for="(item, index) in baseInfo.facilitiesAndOtherReportDto.facilitiesList"
          :key="index"
        >
    ...
    <view>
      <view class="household-txt">三、估价依据</view>
