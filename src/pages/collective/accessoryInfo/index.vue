  ...
  <view class="accessory-info-wrapper">
    <view class="accessory-container">
      ...
      <view class="row">
        ...
        <view class="col w-117">有线电视</view>
        <view class="col w-57">-</view>
        <view class="col">处</view>
        <view class="col w-94">
      ...
      <view class="row">
        ...
        <view class="col w-117">网络宽带</view>
        <view class="col w-57">-</view>
        <view class="col">处</view>
        <view class="col w-94">
          <view class="input-wrapper">
      ...
      <view class="row">
        ...
        <view class="col w-117">空调</view>
        <view class="col w-57">-</view>
        <view class="col">台</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
            <input class="num" />
      ...
      <view class="row">
        ...
        <view class="col w-117">动力电表</view>
        <view class="col w-57">-</view>
        <view class="col">只</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
            <input class="num" />
      ...
      <view class="row">
        ...
        <view class="col w-117">太阳能热水器</view>
        <view class="col w-57">-</view>
        <view class="col">处</view>
        <view class="col w-94">
          <view class="input-wrapper">
      ...
      <view class="row">
        ...
        <view class="col w-117">台阶</view>
        <view class="col w-57">-</view>
        <view class="col">m²</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
            <input class="num" />
      ...
      <view class="row">
        ...
        <view class="col w-117">粪缸（池）</view>
        <view class="col w-57">-</view>
        <view class="col">处</view>
        <view class="col w-94">
          <view class="input-wrapper">
      ...
      <view class="row">
        ...
        <view class="col w-117">水井</view>
        <view class="col w-57">-</view>
        <view class="col">口</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
            <input class="num" />
      ...
      <view class="row">
        ...
        <view class="col w-117">蓄水池</view>
        <view class="col w-57">现浇砼</view>
        <view class="col">m³</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
      ...
      <view class="row">
        <view class="col">13</view>
        <view class="col w-117">围墙</view>
        <view class="col w-57">混凝土</view>
        <view class="col">m²</view>
        <view class="col w-94">
          <view class="input-wrapper">
            <label class="reduce">—</label>
