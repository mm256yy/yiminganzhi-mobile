  ...
  <view class="statistic">
    <view class="inner">
      ...
      <div v-else class="list-wrapper">
        <view class="top-title">
          <text class="title-index">户主/企业名称</text>
          <text class="title-content">工作阶段</text>
          <text class="title-content">问题反馈内容</text>
          <text class="title-content">反馈时间</text>
          <text class="title-content">处理结果</text>
        </view>
        <view class="list">
