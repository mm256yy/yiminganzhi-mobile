  ...
  <view class="content" style="display: flex">
    <div class="report-text" id="printReport" style="display: flex">
      <div style="width: 50%; border: 1px solid #000000; display: flex; flex-direction: column">
        ...
        >
          <div style="width: 25%">
            <span style="font-weight: bold; font-size: 12px">使用权人:</span>
          ...
          <div style="width: 45%">
            <span style="font-weight: bold; font-size: 12px">权属单位:</span>
...
export default {
  ...
  methods: {
    ...
    async getCompensationCardConfig(e) {
        ...
        this.tableData = data.immigrantCompensationCardList.filter(item => item.phType == 'LandNoMove')
        console.log(this.tableData, '测试dada数据')
    },    
    sumball() {
