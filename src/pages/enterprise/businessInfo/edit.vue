<template>
  <view class="form-wrapper">
    ...
    <view class="main">
      ...
      <uni-row v-for="item in pevenueData" :key="item.id" class="row">
      ...
      <uni-row v-for="item in salaryData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4">{{ item.name }}</uni-col>
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in welfareFundData" :key="item.id" class="row">
      ...
      <view class="title" v-if="laborUnionFundsData && laborUnionFundsData.length > 0">
        工会经费
      </view>

      <uni-row v-for="item in laborUnionFundsData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in accumulationFundData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <view class="title" v-if="leaveExpensesData && leaveExpensesData.length > 0">
        离休人员费用
      </view>

      <uni-row v-for="item in leaveExpensesData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in taxPaidData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in entProfitData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <view class="title" v-if="currentAssetLoans && currentAssetLoans.length > 0">
        流动资产贷款
      </view>

      <uni-row v-for="item in currentAssetLoans" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in mngFeePaidData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in otherExpenseData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
      ...
      <uni-row v-for="item in otherData" :key="item.id" class="row">
        <uni-col class="sub-title" :span="4" />
        <uni-col :span="20">
          <uni-row>
            <uni-col :span="8">
...
const title = ref<string>('经营现状信息编辑')
...
const submit = () => {
  ...
  updateLandlordManagementApi(uid.value, params)
    .then((res) => {
      if (res) {
