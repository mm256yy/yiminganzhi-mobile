      ...
      <uni-forms class="form" ref="form" :modelValue="formData">
        ...
        <uni-row>
          ...
          <uni-col :span="12">
            ...
            >
              <uni-data-select v-model="formData.usageType" :localdata="dict[325]" />
            </uni-forms-item>
          </uni-col>
        </uni-row>
        ...
        <uni-row>
          <uni-col :span="12">
            <uni-forms-item
              ...
              name="formData.size"
            >
              <uni-data-select v-model="formData.size" :localdata="dict[269]" />
            </uni-forms-item>
          </uni-col>
          <uni-col :span="12">
            <uni-forms-item
...
onLoad((option: any) => {
  if (option) {
    ...
    if (type === 'edit') {
      title.value = '零星(林)果木评估编辑'
      getLandlordDetail()
    } else if (type === 'add') {
      title.value = '新增零星(林)果木评估'
    }
  }
})
