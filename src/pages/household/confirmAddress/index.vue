<template>
  <view class="confirm-address-wrapper">
    <!-- 选房确认 —— 房屋列表 -->
    <view class="list">
      <view class="list-item">
        ...
        <view class="list-2">
          <uni-row>
            <uni-col :span="12">
              <view class="col">
                ...
                <view class="content">曙光安置区</view>
              </view>
            </uni-col>
            <uni-col :span="12">
              <view class="col">
                <view class="label">宅基地编号：</view>
          ...
          <uni-row>
            ...
            <uni-col :span="12">
              <view class="col">
                <view class="label">宅基地地址：</view>
                <view class="content">新吕县景岭镇大山村</view>
              </view>
            </uni-col>
          </uni-row>
        </view>
