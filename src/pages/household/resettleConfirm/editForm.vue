  ...
  <view>
    ...
    <view class="form-wrap">
      <uni-forms class="form" ref="form" :modelValue="formData">
        ...
        <uni-forms-item label="数量：" :label-width="90" label-align="right" name="formData.number">
          <view v-if="actionType === 'edit'">
            {{ formData.number }}
          </view>
          <uni-easyinput
        ...
        <view class="form-label">
          ...
          <text class="label-txt">备注：</text>
        </view>
        <view class="form-value">
          <input class="ipt" v-model="formData.name" type="text" placeholder="请输入" />
        </view>
      </view> -->
      </uni-forms>
    </view>
