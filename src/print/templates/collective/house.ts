...
import { getHead, getCollectiveTableHead, getHousePic } from '../../common'
import { imgHeight, layout } from '../../config'
import { ProjectType } from '@/types/common'

// 居民户房屋配置模版
export const collectiveHouseDefinition = {
  content: [
    {
      alignment: 'left',
      margin: [0, 8],
...
// 获取 村集体房屋配置信息
export const getCollectiveHouseDefinition = (landlord: LandlordType, projectInfo: ProjectType) => {
  if (!landlord) {
    return collectiveHouseDefinition
  }
  return {
    content: [
